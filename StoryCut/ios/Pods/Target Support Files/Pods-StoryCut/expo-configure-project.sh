...
with_node \
  ...
  --target "/Users/harunselcukcetin/Desktop/StoryCut/ios/Pods/Target Support Files/Pods-StoryCut/ExpoModulesProvider.swift" \
  --entitlement "/Users/harunselcukcetin/Desktop/StoryCut/ios/StoryCut/StoryCut.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-constants" "expo-document-picker" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-media-library" "expo-sqlite" "expo-video-thumbnails"
